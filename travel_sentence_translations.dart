...
"Where can i get the bus?":
      'నేను బస్సును ఎక్కడ పొందగలను?	(Nēnu bassunu ekkaḍa pondagalanu?)',
"What is the next stop?":
...
"We had a great time, thank you.":
      'మాకు గొప్ప సమయం ఉంది, ధన్యవాదాలు.	(Māku goppa samayaṁ undi, dhanyavādālu.)',
"how long did you travel for":
...
"Where can i get the bus?":
      'நான் பஸ்ஸை எங்கே பெற முடியும்?	(Nāṉ passai eṅkē peṟa muṭiyum?)','
"What is the next stop?":
...
"We had a great time, thank you.":
      'ನಾವು ಉತ್ತಮ ಸಮಯವನ್ನು ಹೊಂದಿದ್ದೇವೆ, ಧನ್ಯವಾದಗಳು.	(Namage uttama samayavittu, dhanyavādagaḷu.)',
"how long did you travel for":
...
"Is there a hotel nearby?":
       'কাছাকাছি একটি হোটেল আছে?	(Kāchēi ki hōṭēla āchē?)'
"Is there a restaurant nearby?":
      'কাছাকাছি একটি রেস্টুরেন্ট আছে?	(Kāchākāchi kōna punaruddhārakārī āchē?)'
"Where is the exit?":
...
"this season is the best time to visit ---.":
      'এই ঋতু দেখার জন্য সেরা সময় ---।	(Ēi marasumē dēkhāra sērā samaẏa ---.)',
"whats the best place to visit this summer":
      'এই গ্রীষ্মে দেখার জন্য সেরা জায়গা কি,	(Ēi grīṣmē dēkhāra sērā jāẏagāṭi kī)',
"whats the best place to visit during vacation":
      'ছুটির সময় পরিদর্শন করার জন্য সেরা জায়গা কি 	(Chuṭira samaẏa dēkhāra janya sērā jāẏagāṭi kī)',
"where can i make a call?":
      'আমি কোথায় একটি কল করতে পারেন?	(Āmi kōthāẏa kala karatē pāri?)',
"how often do u travel":
      'আপনি কত ঘন ঘন ভ্রমণ করবেন	(Āpani katabāra bhramaṇa karēna?)',
"We had a great time, thank you.":
      'আমরা একটি মহান সময় ছিল, আপনাকে ধন্যবাদ।	(Āmarā ēkaṭi durdānta samaẏa kāṭiẏēchi, āpanākē dhanyabāda.)',
"how long did you travel for":
      'আপনি কতক্ষণ জন্য ভ্রমণ করেন	(Āpani kata dina bhramaṇa karēchēna?)',
"do you know anyone who lives here?":
      'আপনি এখানে বসবাস যারা কেউ জানেন?	(Āpani ki ēkhānē bāsa karēna ēmana kāukē cēnēna?)',
"when will --- train arrive?":
      'কখন হবে --- ট্রেন আসবে?	(Kakhana --- ṭrēna āsabē?)',
"Do you know any places to visit in the city?":
      'আপনি কি শহরে দেখার জন্য কোন জায়গা জানেন?	(Āpani ki śaharē dēkhāra janya kōnaō jāẏagā jānēna?)',
"where is the nearest hotel":
      'সবচেয়ে কাছের হোটেল কোথায়,	(Nikaṭatama hōṭēla kōthāẏa)',
"what is this place know for?":
      'এই জায়গা কি জন্য জানেন?	(Ēi jāẏagāṭi kīsēra janya jānē?)',
"it is hot/cold here":
...
const Map<String, Map<String, String>> translations_travel = {
"Odia": {
"Can you show me the way to ---":  	'ତୁମେ ମୋତେ ବାଟ ଦେଖାଇ ପାରିବ ---',
"Where can i get the bus?":	        'ମୁଁ କେଉଁଠାରୁ ବସ୍ ପାଇବି?',
"What is the next stop?":	          'ପରବର୍ତ୍ତୀ ଷ୍ଟପ୍ କଣ?',
"How long will it take to reach---":	'ଏହା କେତେ ସମୟ ପହଞ୍ଚିବ ---',
"Is there a hotel nearby?":	        'ନିକଟସ୍ଥ ଏକ ହୋଟେଲ ଅଛି କି?',
"Is there a restaurant nearby?":	'ନିକଟସ୍ଥ ଏକ ରେଷ୍ଟୁରାଣ୍ଟ ଅଛି କି?',
"Where is the exit?":	'ପ୍ରସ୍ଥାନ କେଉଁଠାରେ ଅଛି?',
"Where is the bathroom?":	'ଗାଧୁଆ ଘର କେଉଁଠାରେ?',
"Where are the stores?":	'ଷ୍ଟୋରଗୁଡିକ କେଉଁଠାରେ ଅଛି?',
"this season is the best time to visit ---.":	'ଏହି season ତୁ ପରିଦର୍ଶନ କରିବା ପାଇଁ ସର୍ବୋତ୍ତମ ସମୟ ---',
"whats the best place to visit this summer":	'ଏହି ଗ୍ରୀଷ୍ମ ପରିଦର୍ଶନ କରିବାକୁ ସର୍ବୋତ୍ତମ ସ୍ଥାନ |',
"whats the best place to visit during vacation": 	'ଛୁଟି ସମୟରେ ପରିଦର୍ଶନ କରିବା ପାଇଁ ସର୍ବୋତ୍ତମ ସ୍ଥାନ |',
"where can i make a call?":	'ମୁଁ କେଉଁଠାରେ କଲ୍ କରିପାରିବି?',
"how often do u travel":	'ଆପଣ କେତେଥର ଭ୍ରମଣ କରନ୍ତି |',
"We had a great time, thank you.":	'ଆମର ବହୁତ ଭଲ ସମୟ ଥିଲା, ଧନ୍ୟବାଦ |',
"how long did you travel for":	'ଆପଣ କେତେ ଦିନ ପାଇଁ ଯାତ୍ରା କଲେ?',
"do you know anyone who lives here?":	'ଏଠାରେ କିଏ ରହୁଥିବା ବ୍ୟକ୍ତିଙ୍କୁ ଆପଣ ଜାଣନ୍ତି କି?',
"when will --- train arrive?":	'କେବେ ହେବ --- ଟ୍ରେନ୍ ଆସିବ?',
"Do you know any places to visit in the city?":	'ସହରରେ ପରିଦର୍ଶନ କରିବାକୁ ଆପଣ କ complan ଣସି ସ୍ଥାନ ଜାଣିଛନ୍ତି କି?',
"where is the nearest hotel":	'ନିକଟତମ ହୋଟେଲ କେଉଁଠାରେ ଅଛି |',
"what is this place know for?":	'ଏହି ସ୍ଥାନଟି କଣ ପାଇଁ ଜାଣେ?',
"it is hot/cold here":	'ଏହା ଏଠାରେ ଗରମ / ଥଣ୍ଡା ଅଟେ |',
}
};
const Map<String, Map<String, String>> translations_travel = {
"Marathi": {
...
"Where are the stores?":
      'स्टोअर्स कोठे आहेत?	(Sṭōarsa kōṭhē āhēta?)'',
"this season is the best time to visit ---.":
...
"We had a great time, thank you.":
      'आम्ही चांगला वेळ घालवला, धन्यवाद.	(Āmhī cāṅgalā vēḷa ghālavalā, dhanyavāda.)',
"how long did you travel for":
      'तुम्ही किती दिवस प्रवास केला	(Tumhī kitī divasa pravāsa kēlā)',
"do you know anyone who lives here?"
"when will --- train arrive?":
      --- 'ट्रेन कधी येईल?	--- (Ṭrēna kadhī yēīla?)',
"Do you know any places to visit in the city?":
